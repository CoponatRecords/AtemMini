...
while True:
    ...
    if instrument_group_level() > 0.005: #If there's audio in the instruments group, then rotate cameras
        ...
        if piano_level() > 0.0005:
            print(current_time()+CRED_BLUE_2+' '+CEND+" Instruments Playing - With Piano - Rotating Cameras 123 -"+CRED_GREEN_2+" Current Camera: " +rotate_camera([1,2,3],switcher)+CEND)
            ...
            print(current_time()+CRED_GREEN+' '+CEND+" Instruments Playing - No Piano - Rotating Cameras - 23 - "+CRED_GREEN_2+'Current Camera: '+rotate_camera([2,3],switcher)+CEND)
